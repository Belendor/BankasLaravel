@extends('layouts.app')
 ...
 <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Nuimti lešas {{$account->name}} {{$account->surname}}:</div>
                    ...
                    <div class="table">
                        ...
                        <div class="table-row">
                            ...
                            <div class="row-cell action-box">
                                ...
                                <form id="form" action="{{route('account.subtract', [$account])}}" method="post">
                                    <input class="form-control" id="sum-input" type="number" name="sum" step="0.01" min="0">
                                    @csrf
                                    <button class="btn btn-warning" type="submit">Nuimti lėšas</button>
